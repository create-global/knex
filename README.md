...
This is a forked version of knex which will not throw an error if we pass empty arrays to insert queries.

To publish to creeate global ensure you have a valid github token and run:

`NPM_TOKEN={TOKEN} npm publish`

Follow the standard practice of semver and push tags
